...
contract YourContract {
    ...
    function buyGreenhouseShares(uint256 _sharePercentage) public payable {
        ...
        require(assets[1].active, "Greenhouse A not available");
        require(assets[1].sharesSold + _sharePercentage <= 100, "Not enough shares available");
        require(msg.value >= _sharePercentage * assets[1].pricePerShare, "Insufficient payment");
        
        assets[1].sharesSold += _sharePercentage;
        
        // This is the event from your TODO list!
